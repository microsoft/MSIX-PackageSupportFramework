...
struct json_null_impl : shims::json_null
{
};

struct json_string_impl : shims::json_string
{
...
struct json_number_impl : shims::json_number
{
    template <typename T>
...
struct json_boolean_impl : shims::json_boolean
{
...
struct json_object_impl : shims::json_object
{
    using map_type = std::map<std::string, std::unique_ptr<shims::json_value>, std::less<>>;
...
struct json_array_impl : shims::json_array
{
    ...
    std::vector<std::unique_ptr<shims::json_value>> values;
};
